...
- Name: frontend.spec.ts >> I can see the example tutor in the tuutorit page
- Location: frontend.spec.ts:18:1
...
Call log:
  ...
  - waiting for getByText('Tuomo Tutor')
